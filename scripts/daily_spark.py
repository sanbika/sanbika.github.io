...
- 探索：发现新角落、观察新细节、动手做点小作品、尝试一点小实验；对象必须是外部世界（不熟悉的空间、物件、路径、小实验），不是自己的内在状态
- 内省：独处时落在一个具体动作上的自我整理（对照、整理、复盘、慢观察等），不是纯书写或纯冥想；区别于探索——对照/整理/复盘的对象必须落在自己身上（昨天的一个决定、一种惯常反应、一段对话留下的余味、近期反复出现的小情绪），并伴随一个落到纸面或手上的具体动作（划掉、写一句、挪一挪）
